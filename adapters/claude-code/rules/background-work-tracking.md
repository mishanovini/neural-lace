...
| Hook (Mechanism) | Stalled background-Workflow runs surfaced at every session start; never permanently forgotten | `adapters/claude-code/hooks/stalled-work-surfacer.sh` |
