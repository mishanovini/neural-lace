...
# (docs/backlog.md modified, or docs/reviews/YYYY-MM-DD-*.md added).
# If trigger phrases are present AND no persistence happened, blocks
# session end with a detailed message.
#
