...
6. **Coordination with auto-emit-to-Conv-Tree:** out of scope for v1 (per ADR-036 §7). The panel reads the queue file directly; tree events don't have to know about decisions until a future iteration adds them.

## See also

- `docs/decisions/036-decision-queue-substrate.md` — substrate ADR
