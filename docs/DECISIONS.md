...
| 031 | [Conversation Tree Management UI architecture — r6: CONVERGED on Option 2 (passive local-transcript observer) per Misha's passive-tracker scope clarification; Options 1/1b/3 over-scoped (rejected-with-rationale); Dispatch-readable verified, cloud-only sessions the one blind spot; pending systems-designer pass + final ack](decisions/031-conversation-tree-ui-architecture.md) | 2026-05-16 | Proposed |
