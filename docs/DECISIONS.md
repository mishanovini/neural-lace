...
| 031 | [Conversation Tree Management UI architecture — r5: Dispatch is local (cloud premise corrected, Options 2/3 reopened); "launch real Dispatch" variant struck (unbuildable); Option 1b added (GUI spawns own SDK children). Axis: own-the-surface (1/1b) vs overlay-on-local-Dispatch (2/3). Misha's call + pending systems-designer pass](decisions/031-conversation-tree-ui-architecture.md) | 2026-05-16 | Proposed |
