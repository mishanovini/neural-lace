...
| 031 | [Conversation Tree Management UI architecture — r4: Option 4 struck (r3); options 1/2/3 all genuinely live; r3 Option-1 lean downgraded to leading-candidate-not-settled; decision deferred to post-Stage-F architecture pass + fresh systems-designer review](decisions/031-conversation-tree-ui-architecture.md) | 2026-05-16 | Proposed |
