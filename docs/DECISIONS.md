...
| 031 | [Conversation Tree Management UI architecture — r3: Option 4 struck by stakeholder; option space now 1/2/3 weighed against the "built into Dispatch" ideal + NFR-11; Option 1 ("Dispatch++") recommended-pending, needs fresh systems-designer pass](decisions/031-conversation-tree-ui-architecture.md) | 2026-05-15 | Proposed |
