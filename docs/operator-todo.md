...
- [ ] AUTO: decision waiting on operator — "Action needed: register the coordination publisher on the Windows desktop (one command, one time)." (needs-you `NY-1785394095-d8ec`, tier untiered, session `a3fcb6ea`) — see NEEDS-YOU.md
<!-- AUTO:END -->
