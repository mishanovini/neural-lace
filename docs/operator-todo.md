...
- [ ] AUTO: decision waiting on operator — "Decision needed: which review-independence model unblocks master for branch wip/harness-hardening-2026-07-29." (needs-you `NY-1785357818-7d3f`, tier untiered, session `a3fcb6ea`) — see NEEDS-YOU.md
<!-- AUTO:END -->
