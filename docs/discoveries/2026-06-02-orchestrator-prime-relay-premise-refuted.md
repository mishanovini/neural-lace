...
surfacing). Recorded as ADR 050; built on branch `feat/orchestrator-prime`.

## Implementation log

- `docs/decisions/050-orchestrator-prime-loop-architecture.md` — ADR (the /loop architecture + the verified/refuted boundary).
