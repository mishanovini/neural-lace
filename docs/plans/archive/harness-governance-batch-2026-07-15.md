...
- [x] R1. **Reconcile the two masters to convergence (0/0).** Runbook Part A: fetch pt on the work
...
- [x] R2. **Clean the branch/worktree estate.** Runbook Part B: remove only merged/stale UNOWNED
...
- [x] R3. **Never-diverge design fix.** Diagnose why the masters diverged and why the fork-sync
...
- [x] 1. **Design the review-record primitive** — a structured record (à la close-plan's
  ...
  Verification: design
- [x] 2. **Review-before-deploy gate** — a gate on the DEPLOY step (`install.sh` +
...
- [x] 3. **Directive 1 — evidence-before-fix commit gate** (warn-mode, promotion tracked) — require an evidenced
...
- [x] 4. **Integrate pt/master `artifact-evidence-bar`** — fold pt's §10-generalization (evidence for
  gates/AGENTS/DESIGNS/reviews) into the primitive; land during the pt reconcile. Verification: contract.
- [x] 5. **Evidence-bar evasion-by-omission** — backfill `added_after` on the 31 legacy `blocking:true`
...
- [x] 6. **Commit-capture (this session's residue)** — commit the on-disk `docs/decisions/063*` +
...
_Generated by close-plan.sh on 2026-07-16T07:08:17Z._

### 1. Implementation Summary

Plan: `docs/plans/harness-governance-batch-2026-07-15.md` (slug: `harness-governance-batch-2026-07-15`).

Files touched (per plan's `## Files to Modify/Create`):

- `adapters/claude-code/attic/`
- `adapters/claude-code/doctrine/model-selection.md`
- `adapters/claude-code/hooks/cross-repo-drift-postpush-gate.sh`
- `adapters/claude-code/hooks/gh-merge-canonical-gate.sh`
- `adapters/claude-code/hooks/harness-doctor.sh`
- `adapters/claude-code/hooks/session-start-auto-install.sh`
- `adapters/claude-code/install.sh`
- `adapters/claude-code/scripts/sync-pt-to-personal.sh`
- `adapters/claude-code/scripts/write-review-record.sh`
- `adapters/claude-code/settings.json.template`
- `adapters/claude-code/sync.sh`
- `docs/backlog.md`
- `docs/decisions/063-model-pin-gate-blocks-not-injects.md`
- `docs/decisions/064-never-diverge-single-canonical-master.md`
- `docs/design-notes/review-record-primitive.md`
- `docs/design-notes/status-page-for-ws-ui-adoption.md`
- `docs/handoffs/2026-07-14-model-enforcement-and-rootcause-gate-checkpoint.md`
- `docs/handoffs/2026-07-15-followup-batch-handoff.md`
- `docs/lessons/2026-07-14-credentials-are-available-inject-dont-surrender.md`
- `docs/plans/harness-governance-batch-2026-07-15.md`
- `docs/plans/model-enforcement-2026-07-14-evidence/1.evidence.json`
- `docs/plans/model-enforcement-2026-07-14-evidence/2.evidence.json`
- `docs/plans/model-enforcement-2026-07-14-evidence/3.evidence.json`
- `docs/plans/model-enforcement-2026-07-14-evidence/4.evidence.json`
- `docs/plans/model-enforcement-2026-07-14-evidence/5.evidence.json`
- `docs/runbooks/master-reconcile-and-estate-cleanup.md`
...
0085781 runbook(master-reconcile): reusable reconcile+cleanup procedure; fold R1-R3 into batch plan as orchestrated continue-until-deployed tasks
