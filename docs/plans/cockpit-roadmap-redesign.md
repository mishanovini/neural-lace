...
- 2026-08-04: docs/designs/cockpit-read-through-evidence/measure-seed.js — the design's measurement script persisted per harness review r2 (REQ-A6's read-bench.js seed; homedir-derived paths only).
