...
- 2026-05-05: `docs/plans/harness-gap-16-closure-validation.md` + `docs/plans/build-doctrine-phase-0-migration.md` — NEW plan files. Created in the same session as the roadmap to start work on the next two tranches in parallel. Each new plan file lists its own scope; the act of CREATING them is scope-adjacent to GAP-17 because both are part of the same user-directed roadmap-and-start-work flow ("Please get started"). Subsequent edits to the build-doctrine + build-doctrine-templates trees and to `adapters/claude-code/hooks/plan-closure-validator.sh` etc. are in scope of THOSE plans, not this one.
...
_Generated by close-plan.sh on 2026-05-06T04:26:26Z._

### 1. Implementation Summary

Plan: `docs/plans/harness-gap-17-narrative-doc-sweep.md` (slug: `harness-gap-17-narrative-doc-sweep`).
...
- `docs/plans/harness-gap-17-narrative-doc-sweep-evidence.md`
- `docs/plans/harness-gap-17-narrative-doc-sweep.md`
- `~/.claude/CLAUDE.md`
...
4b81f68 docs(best-practices): expand from stub to full deep-dive guide
...
70c9aca chore(backlog): flag plan-phase-builder Task-tool gap for harness-reviewer
70e5262 feat: capture-codify PR template + CI workflow + 7 decision records (#1)
7fc3c74 plan(1d-E-3): template-vs-live reconciliation per-hook research
7fc90df backlog: HARNESS-GAP-16 — user-facing narrative docs stale + gate blind spot
8832f76 backlog: P2 — Claude Code doesn't dynamically load new agents mid-session
88acd66 chore(backlog): audit gap sub-items A/B/D/E/F IMPLEMENTED — v16
```
