...
- `docs/decisions/047-orchestrator-prime-loop-architecture.md` — NEW (DONE). The ADR (brief called it "068"; correct sequential number is 047).
...
- `docs/DECISIONS.md` — MODIFY (DONE). Index row for ADR 047.
