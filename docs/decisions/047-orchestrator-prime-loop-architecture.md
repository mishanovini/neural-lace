# ADR 047 — orchestrator-prime: the always-on harness-native orchestrator (/loop architecture)
...
**Cross-reference:** the originating brief referred to this as "ADR-068"; the correct sequential number in this repo is 047 (highest prior = 046).
